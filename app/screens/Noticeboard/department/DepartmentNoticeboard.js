    ...
    <View style={styles.container}>
      <ScrollView style = {styles.scrollScreen} >
        ...
        <View style = {{marginTop : 20 ,marginBottom : 20 , }}>
                  <Text style = {{fontSize : 20 , marginTop :5 ,alignSelf :'center'}}> <Octicons name="note" size={25} color="#34dbeb" /> Department Noticeboard</Text>
       </View>
      ...
      <FlatList
          ...
          <View style = {{marginLeft : 280, marginTop : 8}}>
            <TouchableOpacity onPress={() => ButtonEdit(item.id, item.UserID)}>
